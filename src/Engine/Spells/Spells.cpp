...
{
	assert(uCurrentlyLoadedLevelType == WorldType::Outdoor && pParty->armageddon_timer > 0);
	...
	for (Actor& actor : pActors)
	{
		...
		if (incomingDamage > 0)
		{
			...
			else
			{
				...
				{
					pParty->GivePartyExp(pMonsterStats->GetMonsterInfo(actor.pMonsterInfo.uID).uExp);
				}
			}
		}
	}
