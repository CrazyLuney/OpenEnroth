...
{  // закрыть и загрузить записываемый ф-л(при
// сохранении)
	CloseWriteFile();
...
int LODFile_Sprites::_461397()
{
	...
	if (this->field_ECA0 < this->field_ECA4)
		this->field_ECA0 = this->field_ECA4;
...
{ // TODO(captainurist): merge with ODMHeader? This one is written as ODMHeader, but read as CompressedHeader.
	uint32_t uVersion;
	char pMagic[4];
