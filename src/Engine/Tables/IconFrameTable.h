...
public:
	...
	inline const char* GetAnimationName() const
	{
		return anim_name;
	}
	...
	inline unsigned int GetAnimLength() const
	{
		return this->anim_length;
	}
	...
	inline unsigned int GetAnimTime() const
	{
