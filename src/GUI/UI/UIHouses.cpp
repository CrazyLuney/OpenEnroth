...
bool EnterHouse(HOUSE_ID uHouseID)
{
	...
	else
	{
		...
		if (in_current_building_type == BuildingType_Throne_Room && pParty->uFine)
		{  // going to jail
...
void TravelByTransport()
{
	...
	{  //после нажатия топика - travel option selected
